...
public class WorkOut extends JFrame {
	...
	String armText = "This is your arm workout!!!";
	ImageIcon cardioIcon = new ImageIcon("resources/cardio.gif");
	String cardioText = "This is your cardio workout!!!";
	ImageIcon coreIcon = new ImageIcon("resources/sitUP.gif");
	String coreText = "This is your core workout!!!";
	ImageIcon fullIcon = new ImageIcon("resources/Equipment/full_pain.gif");
	String fullText = "This is your full body workout!!!";
	String fullText1 = "This is your full body workout...with EQUIPMENT!!!";
	
	//with equipment
	ImageIcon legIcon1 = new ImageIcon("resources/Equipment/legEquip.gif");
	String legText1 = "This is your leg workout...with EQUIPMENT!!!";
	ImageIcon armIcon1 = new ImageIcon("resources/Equipment/armEquip.gif");
	String armText1 = "This is your arm workout...with EQUIPMENT!!!";
	ImageIcon coreIcon1 = new ImageIcon("resources/Equipment/coreEquip.gif");
	String coreText1 = "This is your core workout...with EQUIPMENT!!!";
	ImageIcon cardioIcon1 = new ImageIcon("resources/Equipment/cardioEquip.gif");
	String cardioText1 = "This is your cardio workout...with EQUIPMENT!!!";
	...
	public Stack <String> Stackicon(int i)
	{
		...
		if(i == 2 && Iconstack.isEmpty()){	//CARDIO
			...
			Iconstack.push("mtn_climber.gif");	
		...
		if(i == 5 && Iconstack.isEmpty()){ 	//LEGS W/ EQUIP
			Iconstack.push("Equipment/dumbell_lunge.gif");
			Iconstack.push("Equipment/dumbell_squat.gif");
		...
		if(i == 6 && Iconstack.isEmpty()){ 	//ARMS W/ EQUIP
			Iconstack.push("Equipment/seated_shoulder_press.gif");
		...
		if(i == 7 && Iconstack.isEmpty()){ 	//CARDIO W/ EQUIP
			Iconstack.push("Equipment/cardioEquip.gif");
			Iconstack.push("Equipment/elliptical.gif");
			Iconstack.push("Equipment/recumbent_bike.gif");

			return Iconstack;
		}
		if(i == 8 && Iconstack.isEmpty()){ 	//CORE W/ EQUIP
			Iconstack.push("Equipment/coreEquip.gif");
	...
	public Stack <String> tStack(int i)
	{
		...
		if(i == 2 && textstack.isEmpty()){	//CARDIO
			...
			textstack.push("Mountain Climbers: \n\n 1)Start in a basic, straight-arm plank position. \n\n 2)Then, as if you were actually running, pull one knee toward your \n chest. As you push that leg back, pull the other knee \n forward. Quickly continue running or 'climbing' in place for one \n minute.");
